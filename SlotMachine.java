...
public class SlotMachine {
    ...
    public SlotMachine() {
        ...
        this.background.changeSize(250, 400); 
        this.background.changeColor("blue");
        this.background.moveHorizontal(30);  
        this.background.moveVertical(35);
            
        this.base.changeSize(30, 300); 
        this.base.changeColor("black");
        this.base.moveHorizontal(80); 
        this.base.moveVertical(285);
        
        this.lever.changeSize(120, 10);
        this.lever.changeColor("black");
        this.lever.moveHorizontal(430); 
        this.lever.moveVertical(85);
    }
